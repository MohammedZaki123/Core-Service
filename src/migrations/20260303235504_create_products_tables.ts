...
export async function up(knex: Knex): Promise<void> {
    ...
    CREATE TABLE product_branch_details (
         ...
         CONSTRAINT uq_pbd_branch_product UNIQUE (product_id, branch_id)
    );
    ...
    CREATE INDEX idx_products_categories_restaurant_id ON products(restaurant_id);
   ...
   BEGIN
       ...
       FROM restaurant_branches where restaurant_id = NEW.restaurant_id;
       RETURN NEW;
   END;
   $$ LANGUAGE plpgsql;
